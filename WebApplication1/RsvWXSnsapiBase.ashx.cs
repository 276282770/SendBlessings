    ...
    public class RsvWXSnsapiBase : IHttpHandler
    {
        ...
        public  void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    string url_getOpenId = $"https://api.weixin.qq.com/sns/oauth2/access_token?appid=wx34ee0c35e400d9d6&secret=b6a88895384d428d7a944d8009f556c9&code={code}&grant_type=authorization_code";
